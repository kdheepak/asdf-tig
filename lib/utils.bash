...
list_all_versions() {
	...
	# Change this function if tig has other means of determining installable versions.
	list_github_tags
}
...
download_release() {
	...
	# TODO: Adapt the release URL convention for tig
...
install_version() {
	...
	(
		...
		# TODO: Assert tig executable exists.
		local tool_cmd
